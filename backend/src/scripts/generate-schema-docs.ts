...
async function generateFromKnownSchema(): Promise<string> {
  ...
  const schema = {
    ...
    profiles: {
      description:
        'Extends auth.users. Auto-created via trigger on signup. One profile row per auth.users row.',
      columns: {
        id: {
          type: 'uuid',
        ...
        role: {
          type: 'text',
          description: 'driver | fleet_manager | admin | support',
          nullable: false,
        },
    ...
    drivers: {
      ...
      columns: {
        ...
        user_id: {
          type: 'uuid',
          description: 'Foreign key to auth.users (nullable for load testing)',
          nullable: true,
        },
        ...
        home_terminal_address: {
          type: 'text',
          description: 'Home terminal location',
          nullable: false,
        },
        ...
        hos_ruleset: {
          type: 'text',
          description: 'property_60h | property_70h | passenger_60h | passenger_70h',
          nullable: false,
        },
        exempt_driver_type: {
          type: 'text',
          description: 'none | short_haul | agriculture | construction',
          nullable: false,
        },
        exemptions: { type: 'jsonb', description: 'Driver-level exemption flags', nullable: false },
        status: {
          type: 'text',
          description: 'available | on_trip | offline | inactive | suspended',
          nullable: false,
        },
        current_vehicle_id: {
          type: 'uuid',
        ...
        current_duty_status: {
          type: 'smallint',
          description: '1=OFF, 2=SB, 3=D, 4=ON',
          nullable: true,
        },
        created_at: { type: 'timestamptz', description: 'Creation timestamp', nullable: false },
        updated_at: { type: 'timestamptz', description: 'Last update timestamp', nullable: false },
    ...
    eld_events: {
      description:
        'Append-only table for all 7 FMCSA event types. Immutability enforced by trigger.',
      columns: {
        id: { type: 'uuid', description: 'Primary key', nullable: false },
        carrier_id: { type: 'uuid', description: 'Foreign key to carriers', nullable: false },
        ...
        event_sequence_id: {
          type: 'integer',
          description: 'Sequence 1-65535 per device per log period',
          nullable: false,
        },
        event_record_status: {
          type: 'smallint',
          description:
            '1=Active, 2=Inactive-Changed, 3=Inactive-ChangeRequested, 4=Inactive-Unidentified',
          nullable: false,
        },
        event_record_origin: {
          type: 'smallint',
          description: '1=Automatic, 2=Driver, 3=Other user, 4=Unidentified',
          nullable: false,
        },
        event_type: {
          type: 'smallint',
          description:
            '1=DutyStatus, 2=IntermLog, 3=PersonalUse, 4=Cert, 5=Login, 6=EnginePower, 7=Malfunction',
          nullable: false,
        },
        event_sub_type: { type: 'smallint', description: 'Event-specific code', nullable: false },
        event_date: {
          type: 'char(6)',
          description: 'MMDDYY in home terminal timezone',
          nullable: false,
        },
        ...
        event_timestamp: {
          type: 'timestamptz',
          description: 'Computed ISO 8601 timestamp',
          nullable: false,
        },
        accumulated_vehicle_miles: {
          type: 'numeric(9,1)',
          description: 'Odometer reading (tenths)',
          nullable: false,
        },
        elapsed_engine_hours: {
          type: 'numeric(7,1)',
          description: 'Engine hours (tenths)',
          nullable: false,
        },
        ...
        location_description: {
          type: 'varchar(60)',
          description: 'Location text (max 60 chars)',
          nullable: true,
        },
        distance_since_last_valid_coords: {
          type: 'numeric(6,1)',
          description: 'Distance since last GPS fix',
          nullable: true,
        },
        malfunction_indicator_status: {
          type: 'boolean',
          description: 'Malfunction indicator lit',
          nullable: false,
        },
        eld_malfunction_status: {
          type: 'boolean',
          description: 'ELD malfunction detected',
          nullable: false,
        },
        data_diagnostic_indicator_status: {
          type: 'boolean',
          description: 'Data diagnostic indicator',
          nullable: false,
        },
        event_data_check_value: { type: 'char(2)', description: 'Hex checksum', nullable: false },
        annotation: {
          type: 'varchar(60)',
          description: 'Driver annotation (max 60 chars)',
          nullable: true,
        },
        driver_eld_account_id: {
          type: 'varchar(60)',
          description: 'Driver ELD account ID',
          nullable: true,
        },
        co_driver_eld_account_id: {
          type: 'varchar(60)',
          description: 'Co-driver account (team driving)',
          nullable: true,
        },
        previous_duty_status: {
          type: 'smallint',
          description: 'Previous duty status (EventType 1 only)',
          nullable: true,
        },
        is_personal_use_active: {
          type: 'boolean',
          description: 'Personal use flag',
          nullable: true,
        },
        is_yard_moves_active: { type: 'boolean', description: 'Yard moves flag', nullable: true },
        malfunction_code: {
          type: 'char(1)',
          description: 'P,E,T,L,R,S,O (EventType 7)',
          nullable: true,
        },
        diagnostic_code: { type: 'char(1)', description: '1-6 (EventType 7)', nullable: true },
        event_metadata: {
          type: 'jsonb',
          description: 'Event-type-specific flexible payload',
          nullable: false,
        },
        version_number: {
          type: 'smallint',
          description: 'Edit version (1, 2, 3...)',
          nullable: false,
        },
        previous_version_id: {
          type: 'uuid',
          description: 'Points to superseded version',
          nullable: true,
        },
        original_version_id: {
          type: 'uuid',
          description: 'Points to original (v1) record',
          nullable: true,
        },
        content_hash: { type: 'char(64)', description: 'SHA-256 of event data', nullable: false },
        chain_hash: {
          type: 'char(64)',
          description: 'SHA-256 of (content_hash || previous_chain_hash)',
          nullable: false,
        },
        previous_chain_hash: {
          type: 'char(64)',
          description: 'Chain hash of previous event',
          nullable: true,
        },
        created_at: {
          type: 'timestamptz',
          description: 'Creation timestamp (no updated_at - append-only)',
          nullable: false,
        },
      },
    },
    ...
    audit_log: {
      ...
      columns: {
        ...
        changed_by_role: {
          type: 'text',
          description: 'User role at time of change',
          nullable: true,
        },
        ...
        old_values: {
          type: 'jsonb',
          description: 'Record before change (NULL for INSERT)',
          nullable: true,
        },
        new_values: {
          type: 'jsonb',
          description: 'Record after change (NULL for DELETE)',
          nullable: true,
        },
        changed_fields: {
          type: 'text[]',
          description: 'Array of field names that changed (UPDATE only)',
          nullable: true,
        },
        ...
        fmcsa_compliance: {
          type: 'boolean',
          description: 'FMCSA compliance flag',
          nullable: false,
        },
        retention_required: {
          type: 'boolean',
          description: 'Retention required flag',
          nullable: false,
        },
        retention_until: {
          type: 'date',
          description: 'Minimum retention date (6 months)',
          nullable: true,
        },
        search_vector: {
          type: 'tsvector',
          description: 'Full-text search vector (generated)',
          nullable: true,
        },
      },
    },
